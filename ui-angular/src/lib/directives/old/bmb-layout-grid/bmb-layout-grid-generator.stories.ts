        ...
        >
          ...
          <div bmbLayoutItem margin="none" [isDynamicItem]="true">
            <bmb-action-icon
              ...
              [tooltipText]="'Copy code' | translate"
            />
          </div>
        </section>
      </ng-template>
...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription('***Grid generator*** is a tool that helps generate grids graphically, provides the code generated dynamically based on the interaction with this tool.', { generalDocLink: 'https://bamboo.tec.mx/latest/dev-tools/coleccion-de-componentes-uC69aq75' })}
${getSpecialSpecifications(`
