...
const meta: Meta<BmbCardExampleComponent> = {
  title: 'Components/Containers/Generic card/Informative Media Simple Horizontal',
...
export const Desktop = cardExampleStory('informative-media-simple-horizontal');
export const Mobile = cardExampleStory('informative-media-simple-horizontal', true);
