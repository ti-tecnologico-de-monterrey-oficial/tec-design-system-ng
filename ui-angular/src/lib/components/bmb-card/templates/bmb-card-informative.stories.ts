...
const template =
  ...
  <div bmbLayout margin="none" gapSize="xl" alignItems="stretch" [flow]="{ m: 'row', l: 'reverse', xl: 'reverse' }">
    ...
    <div bmbLayoutItem [colSm]="4" [colLg]="7" [colXl]="7"><div bmbVerticalLayout margin="none" gapSize="m" justify="spaceBetween" alignItems="stretch" layoutHeight="100%">
      <div bmbVerticalLayoutItem><div bmbLayout margin="none" gapSize="s" alignItems="center" [avoidRowWrap]="true"><bmb-tooltip bmbLayoutItem icon="info" text="Additional information" componentTitle="Information" [size]="20" /><bmb-badge bmbLayoutItem text="Badge" appearance="creative-use-violet" /></div></div>
