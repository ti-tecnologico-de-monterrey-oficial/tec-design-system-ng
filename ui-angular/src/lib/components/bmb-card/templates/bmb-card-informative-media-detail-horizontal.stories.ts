...
const meta: Meta<BmbCardExampleComponent> = {
  title: 'Components/Containers/Generic card/Informative Media Detail Horizontal',
...
export const Desktop = cardExampleStory('informative-media-detail-horizontal');
export const Mobile = cardExampleStory('informative-media-detail-horizontal', true);
