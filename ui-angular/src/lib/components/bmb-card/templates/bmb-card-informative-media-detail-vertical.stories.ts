...
const meta: Meta<BmbCardExampleComponent> = {
  title: 'Components/Containers/Generic card/Informative Media Detail Vertical',
...
export const Desktop = cardExampleStory('informative-media-detail-vertical');
export const Mobile = cardExampleStory('informative-media-detail-vertical', true);
