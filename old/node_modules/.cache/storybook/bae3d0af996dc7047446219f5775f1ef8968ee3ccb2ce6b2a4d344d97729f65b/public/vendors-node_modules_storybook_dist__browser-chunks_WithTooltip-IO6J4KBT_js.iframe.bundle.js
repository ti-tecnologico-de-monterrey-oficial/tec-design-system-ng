"use strict";
(self["webpackChunk_ti_tecnologico_de_monterrey_oficial_tec_design_system_ng"] = self["webpackChunk_ti_tecnologico_de_monterrey_oficial_tec_design_system_ng"] || []).push([["vendors-node_modules_storybook_dist__browser-chunks_WithTooltip-IO6J4KBT_js"],{
...
/* harmony export */ });
/* harmony import */ var _chunk_45UGUKRX_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-45UGUKRX.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-45UGUKRX.js");
/* harmony import */ var _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-CHUV5WSW.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-CHUV5WSW.js");
/* harmony import */ var _chunk_WJYERY3R_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-WJYERY3R.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-WJYERY3R.js");
...
/* harmony import */ var storybook_theming__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! storybook/theming */ "./node_modules/storybook/dist/_browser-chunks/chunk-BRX2HXH7.js");
...
var import_memoizerific = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__toESM)((0,_chunk_WJYERY3R_js__WEBPACK_IMPORTED_MODULE_2__.require_memoizerific)(), 1);
...
var ManagerReferenceNodeContext = react__WEBPACK_IMPORTED_MODULE_4__.createContext(),
  ManagerReferenceNodeSetterContext = react__WEBPACK_IMPORTED_MODULE_4__.createContext();
...
function mapToStyles(_ref2) {
  var _Object$assign2,
    ...
    _ref3 = typeof roundOffsets == "function" ? roundOffsets({
      x,
      y
    }) : {
      x,
  ...
  var commonStyles = Object.assign({
    ...
    _ref4 = roundOffsets === !0 ? roundOffsetsByDPR({
      x,
      y
    }, getWindow(popper2)) : {
      x,
...
function detectOverflow(state, options) {
  ...
  var _options = options,
    ...
    clippingClientRect = getClippingRect(isElement(element) ? element : element.contextElement || getDocumentElement(state.elements.popper), boundary, rootBoundary, strategy),
...
function computeAutoPlacement(state, options) {
  ...
  var _options = options,
    ...
    placements2 = variation ? flipVariations ? variationPlacements : variationPlacements.filter(function (placement2) {
...
function distanceAndSkiddingToXY(placement, rects, offset2) {
  var basePlacement = getBasePlacement(placement),
    ...
    _ref = typeof offset2 == "function" ? offset2(Object.assign({}, rects, {
      placement
    })) : offset2,
    skidding = _ref[0],
    distance = _ref[1];
...
function preventOverflow(_ref) {
  var state = _ref.state,
    ...
    referenceRect = state.rects.reference,
    popperRect = state.rects.popper,
    tetherOffsetValue = typeof tetherOffset == "function" ? tetherOffset(Object.assign({}, state.rects, {
      placement: state.placement
    })) : tetherOffset,
    normalizedTetherOffsetValue = typeof tetherOffsetValue == "number" ? {
  ...
  if (popperOffsets2) {
    if (checkMainAxis) {
      var _offsetModifierState$,
        ...
        arrowPaddingObject = state.modifiersData["arrow#persistent"] ? state.modifiersData["arrow#persistent"].padding : getFreshSideObject(),
        ...
        minOffset = isBasePlacement ? referenceRect[len] / 2 - additive - arrowLen - arrowPaddingMin - normalizedTetherOffsetValue.mainAxis : minLen - arrowLen - arrowPaddingMin - normalizedTetherOffsetValue.mainAxis,
        maxOffset = isBasePlacement ? -referenceRect[len] / 2 + additive + arrowLen + arrowPaddingMax + normalizedTetherOffsetValue.mainAxis : maxLen + arrowLen + arrowPaddingMax + normalizedTetherOffsetValue.mainAxis,
    ...
    if (checkAltAxis) {
      var _offsetModifierState$2,
        ...
        _preventedOffset = tether && isOriginSide ? withinMaxClamp(_tetherMin, _offset, _tetherMax) : within(tether ? _tetherMin : _min, _offset, tether ? _tetherMax : _max);
...
function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  return (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) && ((getNodeName(offsetParent) !== "body" ||
...
var EMPTY_MODIFIERS = [],
  usePopper = function (referenceElement, popperElement, options) {
    ...
    var prevOptions = react__WEBPACK_IMPORTED_MODULE_4__.useRef(null),
      ...
      updateStateModifier = react__WEBPACK_IMPORTED_MODULE_4__.useMemo(function () {
        return {
          name: "updateState",
          enabled: !0,
          phase: "write",
    ...
    return useIsomorphicLayoutEffect(function () {
      ...
      if (!(referenceElement == null || popperElement == null)) {
        var createPopper4 = options.createPopper || createPopper3,
          popperInstance = createPopper4(referenceElement, popperElement, popperOptions);
...
function useControlledState(_ref) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_4__.useState(initial),
    state = _React$useState[0],
    setState = _React$useState[1],
    getLatest = useGetLatest(state),
    set = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function (updater) {
...
function usePopperTooltip(config, popperOptions) {
  ...
  var finalConfig = Object.keys(defaultConfig).reduce(function (config2, key) {
      var _extends2;
      return (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, config2, (_extends2 = {}, _extends2[key] = config2[key] !== void 0 ? config2[key] : defaultConfig[key], _extends2));
    }, config),
    defaultModifiers3 = react__WEBPACK_IMPORTED_MODULE_4__.useMemo(function () {
      return [{
        name: "offset",
        options: {
    ...
    finalPopperOptions = (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, popperOptions, {
  ...
  var _usePopper = usePopper(finalConfig.followCursor ? virtualElement : triggerRef, tooltipRef, finalPopperOptions),
    ...
    popperProps = (0,_chunk_45UGUKRX_js__WEBPACK_IMPORTED_MODULE_0__._objectWithoutPropertiesLoose)(_usePopper, _excluded),
    ...
    isTriggeredBy = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function (trigger) {
    ...
    showTooltip = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function () {
      clearTimeout(timer.current), timer.current = window.setTimeout(function () {
        return setVisible(!0);
      }, finalConfig.delayShow);
    }, [finalConfig.delayShow, setVisible]),
    toggleTooltip = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function () {
    ...
    if (getLatest().finalConfig.closeOnOutsideClick) {
      var handleClickOutside = function (event) {
        var _event$composedPath,
          ...
          target = (event.composedPath == null || (_event$composedPath = event.composedPath()) == null ? void 0 : _event$composedPath[0]) || event.target;
  ...
  var getTooltipProps = function (args) {
      return args === void 0 && (args = {}), (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args, {
        style: (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args.style, styles.popper)
      }, attributes.popper, {
        "data-popper-interactive": finalConfig.interactive
      });
    },
    getArrowProps = function (args) {
      return args === void 0 && (args = {}), (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args, attributes.arrow, {
        style: (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args.style, styles.arrow),
        "data-popper-arrow": !0
      });
    };
  return (0,_chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__._extends)({
    getArrowProps,
    getTooltipProps,
    setTooltipRef,
    setTriggerRef,
...
var {
  ...
  match = (0, import_memoizerific.default)(1e3)((requests, actual, value, fallback = 0) => actual.split("-")[0] === requests ? value : fallback),
  ArrowSpacing = 8,
  Arrow = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div({
    position: "absolute",
    borderStyle: "solid"
  }, ({
    placement
    ...
    borderTopColor: match("top", placement, theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app, "transparent"),
    borderBottomColor: match("bottom", placement, theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app, "transparent"),
    borderLeftColor: match("left", placement, theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app, "transparent"),
    borderRightColor: match("right", placement, theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app, "transparent")
  })),
  ...
  Tooltip = react__WEBPACK_IMPORTED_MODULE_4__.forwardRef(({
    ...
    withArrows,
    ...props
  }, ref) => react__WEBPACK_IMPORTED_MODULE_4__.createElement(Wrapper, {
    "data-testid": "tooltip",
    hasChrome,
    ref,
    ...props,
    color
  }, hasChrome && withArrows && react__WEBPACK_IMPORTED_MODULE_4__.createElement(Arrow, {
    placement,
    ...arrowProps,
    color
  }), children));
...
`,
  WithTooltipPure = ({
    ...
    let Container = svg ? TargetSvgContainer : TargetContainer,
      ...
      portalTarget = (typeof portalContainer == "string" ? document2.querySelector(portalContainer) : portalContainer) || document2.body,
      tooltipComponent = isVisible ? react__WEBPACK_IMPORTED_MODULE_4__.createElement(Tooltip, {
        placement: state?.placement,
        ref: setTooltipRef,
        hasChrome,
    ...
    return react__WEBPACK_IMPORTED_MODULE_4__.createElement(react__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, react__WEBPACK_IMPORTED_MODULE_4__.createElement(Container, {
      trigger,
      ref: setTriggerRef,
      ...props
    }, children), isVisible && react_dom__WEBPACK_IMPORTED_MODULE_5__.createPortal(tooltipComponent, portalTarget));
  },
  WithToolTipState = ({
    startOpen = !1,
    ...
    let [tooltipShown, setTooltipShown] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(startOpen),
      onVisibilityChange = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(visibility => {
  ...
  DeprecatedPure = props => ((0,storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__.deprecate)("WithTooltipPure is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."), react__WEBPACK_IMPORTED_MODULE_4__.createElement(WithTooltipPure, {
    "data-deprecated": "WithTooltipPure",
    ...props
  })),
  DeprecatedState = props => ((0,storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__.deprecate)("WithToolTipState is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."), react__WEBPACK_IMPORTED_MODULE_4__.createElement(WithToolTipState, {
    "data-deprecated": "WithToolTipState",
    ...props
  }));
...
//# sourceMappingURL=vendors-node_modules_storybook_dist__browser-chunks_WithTooltip-IO6J4KBT_js.iframe.bundle.js.map