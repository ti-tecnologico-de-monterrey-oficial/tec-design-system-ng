...
/* harmony import */ var _bmb_input_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./bmb-input.component */ "./projects/ds-ng/src/lib/components/bmb-input/bmb-input.component.ts");
...
\`\`\`
  ...
  argTypes: {
    ...
    errorMessage: {
      ...
      description: 'Text to be displayed when there is an error. This could be a string or any of the following: required, min, max, minLength, pattern.',
      table: {
        category: 'Properties',
        type: {
    ...
    tooltipPosition: {
      ...
      table: {
        category: 'Properties',
        defaultValue: {
          summary: '{ align: "above", justify: "before" }'
        },
        type: {
    ...
    jsonFormat: {
      ...
      description: 'If enabled, the input field will validate the content as a JSON format. Only applies to textarea inputs. You will need to remove the pattern.',
      table: {
        category: 'Properties',
        defaultValue: {
          summary: 'false'
    ...
    isClearable: {
      ...
      description: 'If enabled, a clear button will be displayed in the input field.',
      table: {
        category: 'Properties',
        type: {
          summary: 'boolean'
...
//# sourceMappingURL=lib-components-bmb-input-bmb-input-stories.9890d23434a8e5695b02.hot-update.js.map