"use strict";
self["webpackHotUpdate_ti_tecnologico_de_monterrey_oficial_tec_design_system_ng"]("projects_ds-ng_src_lib_components_bmb-table-lite_bmb-table-lite_component_ts",{
...
let BmbTableLiteComponent = class BmbTableLiteComponent {
  ...
  getCellClasses(row, columnKey, index) {
    ...
    const isSticky = column?.sticky === true || column?.sticky === undefined && index === 0;
    return {
  ...
  getHeaderCellClasses(i) {
    ...
    const isSticky = column?.sticky === true || column?.sticky === undefined && i === 0;
    return {
      'bmb_table_lite-sticky': isSticky,
      truncated: this.truncate()
    };
...
//# sourceMappingURL=projects_ds-ng_src_lib_components_bmb-table-lite_bmb-table-lite_component_ts.b57e1beb754aee338b7f.hot-update.js.map