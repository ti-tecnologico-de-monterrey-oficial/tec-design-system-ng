...
body:has(.bmb_projected-backdrop) {
  overflow: hidden;
}
...
@media screen and (width <= 1000px) and (pointer: coarse) {
  .bmb_projected-content-force-mobile-center:has(input:focus) {
    left: 1rem !important;
    right: 1rem !important;
    top: 1rem !important;
...
//# sourceMappingURL=projects_ds-ng_src_lib_components_bmb-portal_bmb-portal_component_ts.cad7c11d1f416303d184.hot-update.js.map