"use strict";
self["webpackHotUpdate_ti_tecnologico_de_monterrey_oficial_tec_design_system_ng"]("projects_ds-ng_src_lib_components_bmb-accordion_bmb-accordion_stories_ts",{
...
/* harmony export */ });
/* harmony import */ var _bmb_accordion_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bmb-accordion.component */ "./projects/ds-ng/src/lib/components/bmb-accordion/bmb-accordion.component.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  tags: ['!autodocs'],
  component: _bmb_accordion_component__WEBPACK_IMPORTED_MODULE_0__.BmbAccordionComponent,
  decorators: [(0,_storybook_angular__WEBPACK_IMPORTED_MODULE_1__.moduleMetadata)({
    declarations: [],
    imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__.CommonModule, _bmb_accordion_component__WEBPACK_IMPORTED_MODULE_0__.BmbAccordionComponent]
  })],
  parameters: {
    docs: {
      description: {
...
Below is an example of how you can use this component in HTML:
  ...
  argTypes: {
    ...
    accordionId: {
      ...
      description: 'Is a identifier for the component, this attribute is REQUIRED to use the accordion control directive',
      table: {
        category: 'Properties',
        type: {
          summary: 'number'
    ...
    hideToggle: {
      ...
      description: 'This property hides or show the toggle to collapse the accordion',
      table: {
        category: 'Properties',
        type: {
          summary: 'boolean'
    ...
    active: {
      ...
      description: 'When this property is set as true, the accordion is not collapsed, so the content is shown.',
      table: {
        category: 'Properties',
        type: {
          summary: 'boolean'
    ...
    disabled: {
      ...
      description: 'If set to true, disables the accordion, making it non-interactive and unclickable. This is useful for conditions where user interaction should be restricted.',
      table: {
        category: 'Properties',
        defaultValue: {
          summary: 'false'
...
;
const __namedExportsOrder = ["Default", "SelectedItem"];
Default.parameters = {
  ...Default.parameters,
  docs: {
...
SelectedItem.parameters = {
  ...SelectedItem.parameters,
  docs: {
    ...SelectedItem.parameters?.docs,
    source: {
      originalSource: "{\n  args: {\n    active: true\n  },\n  render: (args: any) => ({\n    template: `\n  <bmb-accordion\n    ${attributes(args)}\n  >\n    <ng-template #bmbAccordionHeader>\n      1\n    </ng-template>\n    <ng-template #bmbAccordionContent>\n      <p>\n        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut justo ante,\n        mattis nec libero a, malesuada pellentesque sem. Aliquam erat volutpat.\n        Nulla ut consequat turpis, id efficitur velit. Fusce vitae dolor leo.\n        Praesent diam justo, consectetur in blandit ut, tincidunt vitae enim.\n        Nulla eleifend, leo at finibus volutpat, nulla metus eleifend lacus,\n        ullamcorper dictum augue diam id erat. Donec ac fringilla elit. Aliquam\n        sit amet luctus elit. Suspendisse ante tortor, euismod nec metus id,\n        commodo sollicitudin massa. Aliquam magna nibh, semper eu vestibulum\n        aliquam, aliquet gravida massa. Nullam vehicula, augue non aliquam\n        posuere, enim urna blandit erat, et euismod enim nisi vel eros. Ut dictum\n        egestas mi, faucibus iaculis lorem. Donec risus diam, maximus at varius\n        rutrum, blandit quis augue. Sed consectetur massa ut auctor ultricies.\n        Etiam fringilla venenatis nulla, gravida finibus nulla faucibus fringilla.\n        Morbi luctus porta orci eu iaculis.\n      </p>\n    </ng-template>\n  </bmb-accordion>\n    `\n  })\n}",
      ...SelectedItem.parameters?.docs?.source
    }
  }
};
...
//# sourceMappingURL=projects_ds-ng_src_lib_components_bmb-accordion_bmb-accordion_stories_ts.9890d23434a8e5695b02.hot-update.js.map