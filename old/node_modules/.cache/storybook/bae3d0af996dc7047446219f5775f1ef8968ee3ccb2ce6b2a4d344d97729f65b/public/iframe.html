<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><style>@font-face {
    ...
    console.warn('unable to connect to top frame for connecting dev tools');
  }</script><link href="main.fcde2f90ebc8aff2cee9.css" rel="stylesheet"><style>#storybook-root[hidden],
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./projects/ds-ng/src/lib","files":"**/*.mdx","importPathMatcher":"^\\.[\\\\/](?:projects\\/ds-ng\\/src\\/lib(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"./projects/ds-ng/src","files":"**/*.stories.@(js|jsx|mjs|ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:projects\\/ds-ng\\/src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|mjs|ts|tsx))$"}];
      ...
      import './vendors-node_modules_angular_router_fesm2022_router_mjs-node_modules_storybook_addon-a11y_dis-e1ed5c.iframe.bundle.js';
