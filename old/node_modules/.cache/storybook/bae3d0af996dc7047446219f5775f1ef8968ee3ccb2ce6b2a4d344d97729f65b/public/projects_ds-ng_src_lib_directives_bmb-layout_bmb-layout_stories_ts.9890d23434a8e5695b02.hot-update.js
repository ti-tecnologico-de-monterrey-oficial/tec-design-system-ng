...
const Default = {
  ...
  render: args => ({
    props: args,
    template: `
      <section bmbLayout ${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.attributes)(args)}>
...
;
const __namedExportsOrder = ["Default", "ColumnSmSizes", "ColumnLgSizes", "AutoLayout", "ColumnOffset"];
Default.parameters = {
  ...Default.parameters,
  docs: {
...
//# sourceMappingURL=projects_ds-ng_src_lib_directives_bmb-layout_bmb-layout_stories_ts.9890d23434a8e5695b02.hot-update.js.map