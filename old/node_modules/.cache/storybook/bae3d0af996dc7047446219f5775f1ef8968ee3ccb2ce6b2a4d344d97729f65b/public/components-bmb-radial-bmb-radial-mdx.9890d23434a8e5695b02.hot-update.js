...
Below is an example of how you can use this component in HTML:
  ...
  argTypes: {
    id: {
      ...
      description: 'Sets the unique identifier for the radial component. This is used to link the label to the radial input element using the "for" attribute, improving accessibility and usability.',
      table: {
        category: 'Properties',
        type: {
          summary: 'string'
...
`,
    ...
    name: {
      ...
      description: 'Sets the name of the radial. Multiple radials can share the same name to create a group where one item can be selected.',
      table: {
        category: 'Properties',
        type: {
          summary: 'string'
    ...
    ariaDescribedby: {
      ...
      description: 'Sets additional descriptive text for the radial, improving accessibility by linking the radial to a descriptive element by ID.',
      table: {
        category: 'Properties',
        type: {
          summary: 'string'
    ...
    ariaLabel: {
      ...
      description: 'Sets a label for the radial for accessibility purposes, which can be used when there is no visible label text.',
      table: {
        category: 'Properties',
        type: {
          summary: 'string'
    ...
    ariaLabelledby: {
      ...
      description: 'Identifies the element(s) that labels the radial for accessibility purposes, providing a reference to the IDs of the elements that serve as the radial label.',
      table: {
        category: 'Properties',
        type: {
          summary: 'string'
...
**Note**: This is a snippet from the TypeScript example above.
    ...
    change: {
      ...
      description: 'An event that is emitted when the state of the radial changes, such as when it is checked or unchecked. This can be used to trigger functions or actions based on the radial state change.',
      table: {
        category: 'Events',
        type: {
          summary: '(change)="handleRadial($event)"'
        }
      }
    }
  },
...
//# sourceMappingURL=components-bmb-radial-bmb-radial-mdx.9890d23434a8e5695b02.hot-update.js.map