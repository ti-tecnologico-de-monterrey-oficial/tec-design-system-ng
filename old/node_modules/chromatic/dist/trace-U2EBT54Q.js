...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e892574a-9456-5601-8388-cdc393f9ddc2")}catch(e){}}();

var chunkH54JHVUC_js = require('./chunk-H54JHVUC.js');
...
var c=chunkTKGT252T_js.e(chunkIPJUKAKD_js.s());var{STORYBOOK_BASE_DIR:u,STORYBOOK_CONFIG_DIR:h,WEBPACK_STATS_FILE:k}=process.env;async function B(d){let{flags:t,input:p}=(0, c.default)(`
    Usage
    ...
    `,{argv:d,description:"Trace utility for TurboSnap",flags:{statsFile:{type:"string",alias:"s",default:k||"storybook-static/preview-stats.json"},storybookBaseDir:{type:"string",alias:"b",default:u||"."},storybookConfigDir:{type:"string",alias:"c",default:h||".storybook"},untraced:{type:"string",alias:"u",isMultiple:!0},mode:{type:"string",alias:"m"}}}),e=chunk74IDFOKA_js.b({},{logPrefix:"",logLevel:"info"}),y={log:e,options:{storybookBaseDir:t.storybookBaseDir,storybookConfigDir:t.storybookConfigDir,untraced:t.untraced,traceChanged:t.mode||!0},git:{rootPath:await chunkH54JHVUC_js.y({log:e})},storybook:{baseDir:t.storybookBaseDir,configDir:t.storybookConfigDir}},g=await chunkLZXDNZPW_js.a(t.statsFile),i=p.map(o=>o.replace(/^\.\//,"")),r=i.find(o=>chunkH54JHVUC_js.Z(o));if(r)throw new Error(`Unable to trace package manifest file (${r}) as that would require diffing file contents.`);await chunkH54JHVUC_js.fa(y,g,t.statsFile,i);}

exports.main = B;
//# sourceMappingURL=out.js.map
//# sourceMappingURL=trace-U2EBT54Q.js.map
//# debugId=e892574a-9456-5601-8388-cdc393f9ddc2
