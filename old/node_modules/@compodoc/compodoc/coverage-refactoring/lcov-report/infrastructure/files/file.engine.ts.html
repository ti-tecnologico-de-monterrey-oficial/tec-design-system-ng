...
<head>
    <title>Code coverage report for infrastructure/files/file.engine.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">infrastructure/files</a> file.engine.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!FileEngine.instance) {
...
<span class="cstat-no" title="statement not covered" >                    reject('Error during ' + filepath + ' read');</span>
                } else {
                    resolve(data);
                }
            });
