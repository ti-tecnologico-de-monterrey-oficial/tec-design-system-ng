...
<head>
    <title>Code coverage report for infrastructure/i18n/i18n.engine.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">infrastructure/i18n</a> i18n.engine.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const i18next = require('i18next');
&nbsp;
import {
    TRANSLATION_DE_DE,
    TRANSLATION_EN_US,
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!I18nEngine.instance) {
