...
<head>
    <title>Code coverage report for infrastructure/angular/angular-api.util.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">infrastructure/angular</a> angular-api.util.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const AngularAPIs: Array&lt;IAngularMainApi&gt; = require('../../data/api-list.json');
&nbsp;
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!AngularApiUtil.instance) {
