...
<head>
    <title>Code coverage report for infrastructure/angular/angular-version.util.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">infrastructure/angular</a> angular-version.util.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as semver from 'semver';
...
&nbsp;
    ...
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!AngularVersionUtil.instance) {
...
&nbsp;
    public getAngularVersionOfProject(packageData): string {
        let _result = '';
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (packageData.dependencies) {
...
&nbsp;
    public prefixOfficialDoc(version: string): string {
        return this.isAngularVersionArchived(version) ? <span class="branch-0 cbranch-no" title="branch not covered" >'v2.' </span>: '';
    }
&nbsp;
