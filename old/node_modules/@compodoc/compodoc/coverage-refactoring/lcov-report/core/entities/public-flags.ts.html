...
<head>
    <title>Code coverage report for core/entities/public-flags.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/entities</a> public-flags.ts</h1>
        <div class='clearfix'>
...
<a name='L301'></a><a href='#L301'>301</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { COMPODOC_DEFAULTS } from '../defaults';
&nbsp;
...
&nbsp;
function <span class="fstat-no" title="function not covered" >list(</span>val: string): string[] {
<span class="cstat-no" title="statement not covered" >    return val.split(',');</span>
}
&nbsp;
