...
<head>
    <title>Code coverage report for core/use-cases/display-environment-versions.spec.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> display-environment-versions.spec.ts</h1>
        <div class='clearfix'>
