...
<head>
    <title>Code coverage report for core/use-cases/handle-tsconfig-file.spec.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> handle-tsconfig-file.spec.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const sinon = require('sinon');
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        loggerStubError = sinon.stub(Logger, 'error');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        loggerStubError.restore();</span>
    });
&nbsp;
