...
<head>
    <title>Code coverage report for core/use-cases/setup-flags.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> setup-flags.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { Command } = require('commander');
&nbsp;
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!SetupFlags.instance) {
...
&nbsp;
        PUBLIC_FLAGS.forEach((publicFlag: Flag) =&gt; {
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (publicFlag.parsingFunction) {
                const defaultValue = <span class="cstat-no" title="statement not covered" >publicFlag.stringifyDefaultValue</span>
                    ? JSON.stringify(publicFlag.defaultValue)
                    : publicFlag.defaultValue;
<span class="cstat-no" title="statement not covered" >                this.program.option(</span>
                    publicFlag.flag,
                    publicFlag.description,
