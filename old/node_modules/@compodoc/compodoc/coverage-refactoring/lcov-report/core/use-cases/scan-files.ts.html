...
<head>
    <title>Code coverage report for core/use-cases/scan-files.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> scan-files.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!ScanFile.instance) {
...
&nbsp;
            stream.on('error', <span class="fstat-no" title="function not covered" >error </span>=&gt; {
<span class="cstat-no" title="statement not covered" >                reject(error);</span>
            });
&nbsp;
            stream.on('data', file =&gt; {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (path.extname(file) === '.ts' || <span class="branch-1 cbranch-no" title="branch not covered" >path.extname(file) === '.tsx')</span> {
