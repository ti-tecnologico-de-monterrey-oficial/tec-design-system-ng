...
<head>
    <title>Code coverage report for core/use-cases/display-environment-versions.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> display-environment-versions.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public static getInstance() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!DisplayEnvironmentVersions.instance) {
...
&nbsp;
             ...
             */
            <span class="missing-if-branch" title="else path not taken" >E</span>if (__dirname.substr(-4) !== 'dist') {
...
&nbsp;
            ...
            console.log('');
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (FileEngine.existsSync(cwd + path.sep + 'package.json')) {
                const packageData = FileEngine.getSync(cwd + path.sep + 'package.json');
                <span class="missing-if-branch" title="else path not taken" >E</span>if (packageData) {
