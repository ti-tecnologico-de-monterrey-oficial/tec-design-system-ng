...
<head>
    <title>Code coverage report for core/use-cases/setup-flags.spec.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/use-cases</a> setup-flags.spec.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const expect = require('chai').expect;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        SetupFlags.setup(pkg);</span>
<span class="cstat-no" title="statement not covered" >        options = SetupFlags.programOptions;</span>
    });
&nbsp;
