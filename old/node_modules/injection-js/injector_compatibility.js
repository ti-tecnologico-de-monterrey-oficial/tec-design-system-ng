 ...
 */
import { THROW_IF_NOT_FOUND } from './injector';
/**
...
export function inject(token, options) {
    ...
    const notFoundValue = !(options === null || options === void 0 ? void 0 : options.optional) ? THROW_IF_NOT_FOUND : null;
