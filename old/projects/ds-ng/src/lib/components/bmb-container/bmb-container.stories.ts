...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'container' })} to define specific sections of content, this component encloses and groups other HTML elements.`, { generalDocLink: 'https://bamboo.tec.mx/latest/componentes/global-container/descripcion-general-MJF3dmwC' })}
