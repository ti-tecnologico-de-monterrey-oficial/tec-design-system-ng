...
export class GenericCard {
  ...
  readonly homeItems: HomeCardItem[] = Array.from(
    { length: 5 },
    (_, index) => ({
  ...
  readonly fileItems: HomeCardItem[] = Array.from(
    { length: 5 },
    (_, index) => ({
  ...
  readonly examples: Record<string, GenericCardExample> = {
    informative: {
      ...
      typescript:
        "imports: [BmbCardComponent, BmbTooltipComponent, BmbBadgeComponent, BmbImageComponent, BmbButtonDirective];\nimageUrl = 'YOUR_IMAGE_URL';\nonAction(event: MouseEvent): void { console.log(event); }",
    },
    flat: {
    ...
    home: {
      ...
      typescript:
        "imports: [BmbCardComponent, BmbCardHeaderComponent, BmbCardContentComponent, BmbListGroupComponent, BmbListGroupItemComponent, BmbBadgeComponent];\nitems = [{ id: 'item-1', title: 'Lorem ipsum', description: 'Subtitle' }];\nonSelection(ids: string[]): void { console.log(ids); }",
    },
    empty: {
      components: [
        'BmbCardComponent',
      ...
      typescript:
        'imports: [BmbCardComponent, BmbCardHeaderComponent, BmbCardContentComponent, BmbBoxIconComponent, BmbButtonDirective];\nonAction(event: MouseEvent): void { console.log(event); }',
    },
    alert: {
      components: ['BmbCardComponent', 'BmbBoxIconComponent'],
