...
- fix(componente) merge comflict
- micro CSS update
- formato
- Format CHANGELOG and update styles/components
- Minor formatting, styles and calendar test fixes
- formato
- feat(componente)limpiar CardButton de componentes, y dejar solo templates en generic card
...
- fix broken pr
- Ejemplo base para plantillas
- Temporal
- feat(template) template Informative terminado
- feat(component/text-editor): se agregó selección del color (Bamboo) en el encabezado.
- feat(template) template Empty y documentado en storybook
- feat(component) asegurar funcionalidad implementada
- chore: se actualizó la versión
- feat(componente) agregar iconos (copy) para el chat de usuario y funcionalidad
- feat(componente) card button implementar boxShape de BoxIcon
...
- feat(template) action2 desktop/responsive
- formato
- fix(component / filter card): Se corrigió el bug de filter card donde no se reseteaban los filtros y había insoncistencias en el estado de los elementos seleccionados
- feat: se agregó imagen por defecto para los casos de error generado por imagen rota, se agregó output para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- feat(template) flat desktop/responsive
- fix(component / home card chat): Las acciones del bot en sus diálogos ahora son opcionales
- feat(template) template empty
- feat(template) template Home
- feat(component/image): se implemento validación de error, se emite función y se agrega imagen por defecto.
- Refactor grid cols, add calendar-today, demo cards
- feat(template / guide tour): Se agregaron los estilos para el template guide tour
...
- feat(component/text-editor): se aplicó el color selección al texto indicado.
- feat(template) template Action
- feat(template) template Flat
- Update bmb-box-icon.stories.ts
- Introduce columns-builder mixin; add color alias
- chore: se homologó el nombre a desktop.
- feat(styles) restablecer estilos \_cardsd.scss
...
- chore: se borro código innecesario.
...
- Potential fix for pull request finding
- feat(component) implementar throw al fallar copiado
- fix(merge) merge con feature-prod
- feat(template) template Informative
- feat(componente) agregar tooltip a template BmbCardButtonInformative
- feat(component/image): se agrego imagen por defecto para los casos de error generado por imagen rota, se emite también error generado por imagen rota.
- feat(componente) agregar test y validar de templates
- fix(component / portal): Se corrigio el error de cerrar el componente una vez se hace click por fuera
- feat(component/action-icon): se replicó el output del bmb-icon para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- Update table-main.component.html
- chore: se ocultaron los parámetros que son métodos y atributos.
- chore: se agregaron colores para "Text editor".
- Formato
- feat(component/): se agregó imagen por defecto para los casos de error generado por imagen rota, se agregó output para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- Ejemplo base para plantillas
- feat(component/container-button-badge): se replicó el output del bmb-icon para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- feat(component/box-icon): se replicó el output del bmb-icon para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- feat(component/action-icon): se agregó input interno para asignar un valor al tooltip base.
- Formato
- chore: se cambió las imagen por defecto del error del src al srcset.
- Formato
- feat(template) limpiar templates de estilos
- fix(component) cambios de origin e implementar throw
- format
- chore(componente) agregar templates para BmbCardButton
- docs(componente) CardButton templates en stoybook
- temporal
- temporal: con uso de "Dot paginator".
- docs(componente) card button, agregar algunos templates para el componente
- fix(componente) mantener regla de caracteres invalidos y agregar propiedad para archivos duplicados como input
- chore: pruebas para componente "Table".
- fix(component/tables): Se agregó soporte para detectar cambios en las
- feat: se implemento plantilla de variante con "Home card" para el "Guided tour".
- fix(componente) bmb-dropzone agregar validacione en archivos duplicados y caracteres no validos en nombre
- feat(component/text-link): se realizó ajuste para aplicar el estilo base de enlaces.
- chore: se agregó mayor detalle en la documentación técnica del "Guided tour".
- chore: correcciones a reporte de ejecución de Chromatic.
- feat(component/accordion): se replicó el output del bmb-icon para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- chore: documentación de la plantilla ejemplo del "Guided tour".
...
- fix(component/table): Se agrego la definición del template en la definición de la columna
- chore: refactorización de estilos de enlaces ("Text link") para evitar que afecte a las etiquetas "a" que no lo requieran.
- chore: se agregaron variantes para apoyo en la documentación.
- feat(component/icon): se agregó output para uso de desarrolladores para que manejen los errores de la manera que lo requieran.
- chore: se agregó variables de color de general contrast.
- chore: se realizó ajuste según diseño Figma debido.
- feat(component/drawer): se realizó ajuste para permitir un elemento más en el menú.
- fix(test) eliminar validación de variable eliminada language en test
...
- chore: se agregó documentación de la nueva propiedad (model) en el componente "Carousel"
- feat(componente) se agrego input boxShape para manipular el border-radius del icono
- chore: se implementó MDX para el "Guided tou"
- feat(component/text-link): se realizó ajuste para aplicar el estilo base de enlaces.
- doc(component/table): Se actualizó la documentación de la tabla
- chore: se realizó ajuste para aplicar el estilo base de enlaces.
- chore: se agregó documentación referente al estilo de fuente asignada por defecto según la etiqueta de HTML.
- Formato
...
- chore: pruebas "Text editor".
- Refactor boxShape parameter in bmb-box-icon stories
- chore: se agregó documentación de la nueva propiedad (model) en el componente "Carousel"
- fix(componente) usar servicio BmbTranslationsService para obterner el lengiaje actual
- feat(componente) cambiar boxShape:circle de 48px a 50%
- formato
- chore: se eliminó la animación para los enlaces, solo se implementará en el "Text link".
- feat(component/icon): se agregó output para uso de desarrolladores para que manejen los errores de la manera que lo requiera.
- feat(component/dropzone): se realizó ajuste para aplicar el estilo base de enlaces.
- Formato
- chore: se ocultó contenido en la documentación.
- formato
- chore: se cambiaron los botones por "Action icon" para aprovechar las características de Bamboo.
- chore: se ocultó contenido en la documentación.
- feat(component/drawer-overlay): se agregó variable para definir el límite de elementos.
- chore: se agregó valor para tener una documentación más completa.
- fix(test) eliminar validación de variable eliminada language en test
- feat(componente) remover rem_cal para la propiedad circle en boxShape
...
- Formato
- formato
- Merge pull request #1162 from ti-tecnologico-de-monterrey-oficial/DS01-3300
- Formato
- progress circle changes
- Potential fix for pull request finding
- Progress Circle: Aplicar mejoras en el componente.
...
- chore: se agregaron colores de fuente o elementos contenidos en fondo específicos con el objetivo de estandarizarlo en los componentes.
- feat(component/card): migrate inputs and outputs to signals
- feat(component/paginator): migrate inputs and outputs to signals
- feat(component/server-table): migrate inputs and outputs to signals
- feat(component/modal): migrate inputs and outputs to signals
- feat(component/pull-wedge): migrate inputs and outputs to signals
...
- feat(component/timestream-detail): migrate inputs and outputs to signals
...
- feat(component/legend): migrate inputs and outputs to signals
...
- feat(component/top-bar-item): migrate inputs and outputs to signals
...
- Update bmb-profile.component.html
- Update bmb-date-range.component.ts
...
- chore: ajustes en documentación , se aplicaron descripciones reutilizables.
- roll back user summary changes
- chore: escenarios de pruebas integrales en aplicaciones
- feat(component/accordion-control): migrate inputs and outputs to signals fix
- fix(component/action-menu): se agregaron estilos para organizar contenido de manera responsiva.
- feat(component/pull-wedge): migrate inputs and outputs to signals fix
- feat(component/layout-bienvenida): migrate inputs and outputs to signals
...
- feat(component/FAB Overlay drawer): se realizaron ajustes de estilos y estados del componente según Figma.
- topbar user
- version
...
- chore: se cambio el nombre según estandar.
- Update preview.ts
...
- chore: se eliminó código que no se utiliza
- feat(component/icon): se agregó imagen para uso de desarrolladores cuando no encuentren la imagen inicial.
...
Refactor boxShape parameter to use getAppearanceParam for better maintainability.
