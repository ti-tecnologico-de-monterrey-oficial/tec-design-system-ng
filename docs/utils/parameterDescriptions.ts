...
export const ON_CLICK_DESCRIPTION =
  ', this event is only emitted if the *link* property is empty';
export const GOOGLE_FONTS_LINK = `${getAlertBlockquote(
...
export const ICON_IMAGE_DETAIL = `${getAlertBlockquote(
...
export const getControlDescription = (isComplete = false): string => `
