...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'ButtonGroup', type: 'directive' })} to add the same property to buttons that are inside the element that groups them.`, 'https://bamboo.tec.mx/latest/componentes/button-group/descripcion-general-39ELIbCW')}
