...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'Button', type: 'directive', alternativeDescription: 'that provides styles for buttons.' })} to add the look and feel to buttons.`, 'https://bamboo.tec.mx/latest/componentes/button/descripcion-general-zJtdNHZZ')}
${getArchitectureSection(`
