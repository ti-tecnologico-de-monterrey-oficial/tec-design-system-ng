...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'icon-item' })} o create elements to display information in two columns.`, 'https://bamboo.tec.mx/latest/componentes/icon-item/descripcion-general-F7c7dOy7')}
