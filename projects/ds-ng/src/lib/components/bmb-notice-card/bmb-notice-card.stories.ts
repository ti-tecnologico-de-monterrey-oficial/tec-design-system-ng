...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'notice-card' })} pop-up news or information notifications to be displayed within ***mitec*** in the ***web*** version.`, 'https://bamboo.tec.mx/latest/particularities/mitec-web/notice-card-sfSif5Rk')}
