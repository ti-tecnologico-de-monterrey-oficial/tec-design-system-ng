...
<br/>
  ...
  args: {
    ...
    options: [
      ...
      { name: 'Strawberry name', value: '_strawberry', icon: 'favorite', id: 'strawberry_' },
      { name: 'Blueberry name', value: '_blueberry', icon: 'circle', id: 'blueberry_' },
      { name: 'Watermelon name', value: '_watermelon', icon: 'water_drop', id: 'watermelon_' },
      { name: 'Pineapple name', value: '_pineapple', icon: 'sunny', id: 'pineapple_' },
      { name: 'Cherry name', value: '_cherry', icon: 'heart_broken', id: 'cherry_' },
      ...
      { name: 'Coconut name', value: '_coconut', icon: 'beach_access', id: 'coconut_' },
    ],
