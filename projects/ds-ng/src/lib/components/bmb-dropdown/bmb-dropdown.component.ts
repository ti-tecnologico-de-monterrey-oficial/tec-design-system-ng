...
import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, HostListener, Input, OnChanges, OnInit, Output, SimpleChanges, ViewChild, ViewEncapsulation, forwardRef } from '@angular/core';
...
export class BmbDropdownComponent implements AfterViewInit, ControlValueAccessor, OnChanges, OnInit {
