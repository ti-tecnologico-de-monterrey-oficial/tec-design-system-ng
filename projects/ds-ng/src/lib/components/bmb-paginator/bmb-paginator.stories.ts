...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'paginator' })} to add controls to navigate between pages, using "next" and "previous" buttons, even displays a specific subset of the total pages at a time.`, 'https://bamboo.tec.mx/latest/componentes/paginator/descripcion-general-ermvHDlX')}
${getBasicExampleBlock(
