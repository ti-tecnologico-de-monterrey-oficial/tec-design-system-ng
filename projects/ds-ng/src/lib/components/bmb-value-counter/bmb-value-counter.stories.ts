...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'value-counter' })} to display progress considering a fraction of a total value.`, 'https://bamboo.tec.mx/latest/componentes/value-counter/descripcion-general-9QAWIHwf')}
