...
const meta: Meta<BmbCardComponent> = {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'card' })} to present whether type of content in an orderly manner with card features.`, 'https://bamboo.tec.mx/latest/components/generic-card/descripcion-general-ArPVPcRB')}
