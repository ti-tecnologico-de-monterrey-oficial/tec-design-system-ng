...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'user-image' })} an online identity to be established.`, 'https://bamboo.tec.mx/latest/componentes/user-image/descripcion-general-nwfVZScf')}
