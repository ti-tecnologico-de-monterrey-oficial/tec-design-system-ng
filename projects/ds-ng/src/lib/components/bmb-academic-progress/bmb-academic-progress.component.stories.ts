...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'academic-progress' })} to be provided clearly and quickly, with a focus on readability and visual hierarchy.`, 'https://bamboo.tec.mx/latest/componentes/academic-progress/descripcion-general-f8fNoijD')}
