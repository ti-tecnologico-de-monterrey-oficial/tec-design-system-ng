...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'student-activity-selector' })} to organize the information in three types of selectors (3 is the limit).`, 'https://bamboo.tec.mx/latest/components/student-activity-selector/descripcion-general-77DLiLfG')}
