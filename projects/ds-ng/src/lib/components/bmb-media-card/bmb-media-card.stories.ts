...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
${getGeneralDescription({ content: `${getGeneralComponentDescription({ name: 'media-card' })} visual information to be presented with customizable properties such as image, title, subtitle, user information, and more.`, generalDocLink: 'https://bamboo.tec.mx/latest/componentes/media-card/descripcion-general-MwpzDjrj' })}
