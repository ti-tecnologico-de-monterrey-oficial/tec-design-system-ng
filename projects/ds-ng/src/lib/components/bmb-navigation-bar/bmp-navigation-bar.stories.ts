...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription({ content: `${getGeneralComponentDescription({ name: 'navigation-bar' })} for quick access to key navigation functions and common actions.`, generalDocLink: 'https://bamboo.tec.mx/latest/componentes/navigation-bar/descripcion-general-vOGTleaR' })}
