...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'grades', type: 'organism' })} to display students' grades for a school period.`, 'https://bamboo.tec.mx/latest/organismos/grades/descripcion-general-F5HIJ8av')}
