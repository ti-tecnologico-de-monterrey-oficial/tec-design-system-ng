...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'totp' })} to be used in two-factor authentication flows.`, { generalDocLink: 'https://bamboo.tec.mx/latest/componentes/to-tp-prompt/descripcion-general-ldU6LSaF' })}
