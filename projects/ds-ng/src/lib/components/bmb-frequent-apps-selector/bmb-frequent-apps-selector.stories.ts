...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription({ content: `${getGeneralComponentDescription({ name: 'frequent-apps-selector' })} the implementation of a carousel-type selector to quickly identify and access the most frequently used applications.`, generalDocLink: 'https://bamboo.tec.mx/latest/componentes/frequent-apps-selector/descripcion-general-x3K6Mm3k' })}
