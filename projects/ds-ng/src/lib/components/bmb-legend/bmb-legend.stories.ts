...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'legend' })} to show a correlation between data or values and their representation.`, 'https://bamboo.tec.mx/latest/componentes/legend/descripcion-general-23itzHxE')}
