...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'loader' })} to indicate that a process is running.`, 'https://bamboo.tec.mx/latest/componentes/loading-screens/descripcion-general-TzvjIs5D')}
