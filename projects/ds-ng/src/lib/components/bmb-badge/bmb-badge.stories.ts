...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription({ content: `${getGeneralComponentDescription({ name: 'badge' })} to highlight information in small indicators.`, generalDocLink: 'https://bamboo.tec.mx/latest/componentes/badge/descripcion-general-dqHBPuku' })}
