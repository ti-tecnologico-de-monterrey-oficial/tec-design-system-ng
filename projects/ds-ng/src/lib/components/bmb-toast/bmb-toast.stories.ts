...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'toast' })} to display a short, non-critical message without interrupting browsing or the task at hand.`, { generalDocLink: 'https://bamboo.tec.mx/latest/componentes/toast/descripcion-general-1yUMwDNA' })}
