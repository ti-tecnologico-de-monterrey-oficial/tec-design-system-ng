...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'hito-card' })} to highlight an important stage in a project, process or timeline in a content card.`, 'https://bamboo.tec.mx/latest/componentes/hito-card/descripcion-general-rau61m3C')}
