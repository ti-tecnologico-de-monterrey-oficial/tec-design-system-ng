...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'sounds-card', type: 'element' })} a graphical interface to be displayed for use in audio playback.`, 'https://bamboo.tec.mx/latest/particularities/mitec-web/tec-sound-card-AssAgA82')}
${getBasicExampleBlock(
