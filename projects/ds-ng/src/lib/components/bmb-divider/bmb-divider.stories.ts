...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'divider' })} to separate sections of content, improving organization and visual clarity.`, 'https://bamboo.tec.mx/latest/componentes/divider/descripcion-general-Z8NNTVA9')}
${getArchitectureSection(`
