...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'invoice' })} to generate electronic invoices.`, 'https://bamboo.tec.mx/latest/componentes/invoice/descripcion-general-cAzfIad4')}
