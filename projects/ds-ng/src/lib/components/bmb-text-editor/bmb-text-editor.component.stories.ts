...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'text-editor' })} to write, format, and customize text intuitively. It's ideal for creating rich content, such as posts, comments, or notes.`, 'https://bamboo.tec.mx/latest/componentes/text-editor/descripcion-general-jiiQGEbd')}
