...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: `
${getGeneralDescription(`${getGeneralComponentDescription({ name: 'account-statement', type: 'organism' })} the display of student payment information within Tec de Monterrey.`, 'https://bamboo.tec.mx/latest/organismos/account-statement/descripcion-general-yMI2rj1D')}
