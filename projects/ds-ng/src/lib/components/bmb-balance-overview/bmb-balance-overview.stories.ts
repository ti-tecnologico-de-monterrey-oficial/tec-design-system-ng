...
Below is an example of how you can use this component in HTML:
  ...
  argTypes: {
    progressCirclePercent: {
        ...
        description: 'Refers to the percentage that the Progress Circle component show.',
        table: {
          category: 'Properties',
          type: { summary: 'number' },
    ...
    progressCircleValue: {
        ...
        description: 'Refers to the total value that the Progress Circle component show.',
        table: {
          category: 'Properties',
          type: { summary: 'string' },
    ...
    progressCircleTitle: {
        ...
        description: 'Is the text of the Progress Circle, to show the text in one line use a simple array, if you want to show the title in more than one line, use an array string',
        table: {
          category: 'Properties',
